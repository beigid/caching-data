...
export default {
  ...
  created () {
    ...
    let cacheLabel = `curretnWeather_${this.$route.params.cityId}`;
    let cacheExpity = 15 * 60 * 1000; //15 minutes
    ...
    console.log(`Cache detected for ${cacheLabel}.`);   this.weatherData = this.$ls.get(cacheLabel);
    this.showLoading = false;
    }
